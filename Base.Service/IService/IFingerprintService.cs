...
public interface IFingerprintService
{
    ...
    Task<ServiceResponseVM> UpdateFingerprintTemplate(Guid studentId, string fingerprintTemplate1, DateTime? fingerprint1Timestamp, string fingerprintTemplate2, DateTime? fingerprint2Timestamp);
}
