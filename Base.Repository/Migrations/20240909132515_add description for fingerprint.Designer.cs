...
namespace Base.Repository.Migrations
{
    ...
    [Migration("20240909132515_add description for fingerprint")]
    partial class adddescriptionforfingerprint
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Base.Repository.Entity.ImportSchedulesRecord", b =>
                {
                    b.Property<int>("ImportSchedulesRecordID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ImportSchedulesRecordID"), 1L, 1);

                    b.Property<bool>("ImportReverted")
                        .HasColumnType("bit");
                    ...
                    b.HasKey("ImportSchedulesRecordID");

                    b.HasIndex("UserId");

                    b.ToTable("ImportSchedulesRecord", (string)null);
                });
            ...
            modelBuilder.Entity("Base.Repository.Entity.Module", b =>
                {
                    ...
                    b.Property<int>("AttendanceSoundDurationMs")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ConnectionSoundDurationMs")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Base.Repository.Entity.Schedule", b =>
                {
                    ...
                    b.HasIndex("ImportSchedulesRecordID");
            ...
            modelBuilder.Entity("Base.Repository.Entity.SlotType", b =>
                {
                    b.Property<int>("SlotTypeID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SlotTypeID"), 1L, 1);
            ...
            modelBuilder.Entity("Base.Repository.Entity.Class", b =>
                {
                    ...
                    b.HasOne("Base.Repository.Entity.SlotType", "SlotType")
                        .WithMany("Classes")
            ...
            modelBuilder.Entity("Base.Repository.Entity.ImportSchedulesRecord", b =>
                {
                    b.HasOne("Base.Repository.Identity.User", "User")
                        .WithMany("ImportSchedulesRecords")
            ...
            modelBuilder.Entity("Base.Repository.Entity.Schedule", b =>
                {
                    ...
                    b.HasOne("Base.Repository.Entity.ImportSchedulesRecord", "ImportSchedulesRecord")
                        .WithMany("ImportedSchedules")
                        .HasForeignKey("ImportSchedulesRecordID");
                    ...
                    b.Navigation("ImportSchedulesRecord");
            ...
            modelBuilder.Entity("Base.Repository.Entity.ImportSchedulesRecord", b =>
                {
                    b.Navigation("ImportedSchedules");
                });
            ...
            modelBuilder.Entity("Base.Repository.Identity.User", b =>
                {
                    ...
                    b.Navigation("ImportSchedulesRecords");
